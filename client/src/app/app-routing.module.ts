...
const routes: Routes = [{path: '', redirectTo: 'home', pathMatch: 'full'},
  ...
  {path: 'subject', component: SubjectComponent, data: {breadcrumb: 'Gestão de Unidades Curriculares'}},
      {path: 'subject/addSubject', component: SubjectFormComponent, data: {breadcrumb: 'Nova Unidade Curricular'}},
      ...
      {path: 'gradeCourse', component: GradeCourseComponent, data: {breadcrumb: 'Notas Estudantes'}},
